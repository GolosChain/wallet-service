...
| Параметр |   Тип    | Обяз. | Описание                                                             |
|:--------:|:--------:|:-----:|----------------------------------------------------------------------|
|  amount  | `number` |  Да   | asset.amount                                                         |
|   decs   | `number` |  Да   | asset.decs. Может быть только равным 3, что соответствует (GOLOS, 3) |

Пример:

Получим примерную стоимость `42.000 GOLOS` в `GESTS`.

```json
{
  "jsonrpc": "2.0",
  "id": 1,
  "method": "convertTokenToVesting",
  "params": {
    "decs": 3,
    "amount": 42000
  }
...
|:--------:|:--------:|:-----:|----------------------------------------------------------------------|
|  amount  | `number` |  Да   | asset.amount                                                         |
|   decs   | `number` |  Да   | asset.decs. Может быть только равным 6, что соответствует (GOLOS, 6) |
